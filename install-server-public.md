...
Membuat enkripsi **LUKS (Linux Unified Key Setup)** pada Logical Volume. CIS merekomendasikan penggunaan enkripsi pada media penyimpanan untuk melindungi data apabila perangkat hilang atau diakses oleh pihak yang tidak berwenang.
